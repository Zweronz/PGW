ÐTShader "Hidden/Glow 11/BlurEffectConeTap" {
Properties {
 _MainTex ("", any) = "" {}
...
BindCB  "$Globals" 0
"ps_4_0
eefieceddnlkmbmnnhnlkcodlngfgenommdglbpdabaaaaaakaacaaaaadaaaaaa
...
BindCB  "$Globals" 0
"ps_4_0_level_9_1
eefiecedngknfljoeicgfefajpodihmfeoegodngabaaaaaalaadaaaaaeaaaaaa
