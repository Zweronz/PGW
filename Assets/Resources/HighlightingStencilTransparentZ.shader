¯6Shader "Hidden/Highlighted/StencilTransparentZ" {
Properties {
 _MainTex ("", 2D) = "" {}
 _Cutoff ("", Float) = 0.5
}
...
"vs_4_0
eefiecedkffehdddjdljchbjfafdhnaljcggbihgabaaaaaaamacaaaaadaaaaaa
...
BindCB  "UnityPerDraw" 1
"vs_4_0_level_9_1
eefiecedhgmekmjeknldfgigfehohmfclnhfkcbjabaaaaaapiacaaaaaeaaaaaa
...
BindCB  "$Globals" 0
"ps_4_0
eefiecedmmdmahiflbolkikcajlocmdahilmfchmabaaaaaakaabaaaaadaaaaaa
...
aaaaaaaadkaabaaaaaaaaaaaakiacaiaebaaaaaaaaaaaaaaadaaaaaadbaaaaah
...
BindCB  "$Globals" 0
"ps_4_0_level_9_1

...
akiacaiaebaaaaaaaaaaaaaaadaaaaaadbaaaaahbcaabaaaaaaaaaaaakaabaaa
aaaaaaaaabeaaaaaaaaaaaaaanaaaeadakaabaaaaaaaaaaadgaaaaagpccabaaa
aaaaaaaaegiocaaaaaaaaaaaabaaaaaadoaaaaabejfdeheofaaaaaaaacaaaaaa
