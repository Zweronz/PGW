...
namespace ICSharpCode.SharpZipLib.Tar
{
	public class TarArchive : IDisposable
	{
		...
		private ProgressMessageHandler m_ProgressMessageEvent;
		...
		public event ProgressMessageHandler ProgressMessageEvent
		{
			add
			{
				ProgressMessageHandler progressMessageHandler = this.m_ProgressMessageEvent;
				ProgressMessageHandler progressMessageHandler2;
				do
				{
					progressMessageHandler2 = progressMessageHandler;
					progressMessageHandler = Interlocked.CompareExchange(ref this.m_ProgressMessageEvent, (ProgressMessageHandler)Delegate.Combine(progressMessageHandler2, value), progressMessageHandler);
				}
				while (progressMessageHandler != progressMessageHandler2);
			}
			remove
			{
				ProgressMessageHandler progressMessageHandler = this.m_ProgressMessageEvent;
				...
				{
					progressMessageHandler2 = progressMessageHandler;
					progressMessageHandler = Interlocked.CompareExchange(ref this.m_ProgressMessageEvent, (ProgressMessageHandler)Delegate.Remove(progressMessageHandler2, value), progressMessageHandler);
				}
				while (progressMessageHandler != progressMessageHandler2);
			}
		}
