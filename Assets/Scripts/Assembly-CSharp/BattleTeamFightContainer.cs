...
public class BattleTeamFightContainer : BattleModeContainer
{
	...
	private int TeamBattleCompare(BattlePlayerData battlePlayerData_0, BattlePlayerData battlePlayerData_1)
	{
