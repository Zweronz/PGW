...
public class InvitationsPanelSwitch : MonoBehaviour
{
	...
	{
		Debug.Log("press " + bool_0);
		if (bool_0)
		{
			GetComponent<UISprite>().String_0 = "trans_btn_n";
		}
		else
		{
			GetComponent<UISprite>().String_0 = "trans_btn";
		}
	}
	...
	private void OnClick()
	{
		...
		foreach (GameObject gameObject2 in array2)
		{
			...
			gameObject2.GetComponent<UISprite>().String_0 = "trans_btn";
		}
