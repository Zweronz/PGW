...
public class StockSaleWindowItem : MonoBehaviour
{
	...
	private IEnumerator LoadModel()
	{
		...
		case SlotType.SLOT_WEAR_CAPE:
		{
			...
			localPosition = new Vector3(124f, -77f, -100f);
		...
		case SlotType.SLOT_WEAR_SKIN:
		{
			...
			localPosition = new Vector3(136f, -180f, -100f);
			...
			component.material.SetVector("_ClipBounds", new Vector4(0.16f, -0.31f, 1.04f, -1.06f));
			component.material.SetVector("_ClipLocal", new Vector4(0f, -1f, 0f, 0f));
		...
		if (gameObject_0 != null)
		{
			...
			if (array != null && mesh != null)
			{
				...
				if (array.Length > 0)
				{
					...
					material.SetVector("_ClipBounds", new Vector4(1f, -1f, 1.04f, -1.06f));
				}
	...
	private void OnClick()
	{
		...
		{
			StockWeaponSaleWindow.StockWeaponSaleWindow_0.Hide();
			Lobby.Lobby_0.Hide();
