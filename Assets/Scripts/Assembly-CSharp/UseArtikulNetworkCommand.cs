...
[ProtoContract]
public class UseArtikulNetworkCommand : AbstractNetworkCommand
{
	[ProtoMember(1)]
	...
	{
		Log.AddLine("UseArtikulNetworkCommand::Answered > OK");
	}

	private new static void Init()
	{
		NetworkCommands.Register(typeof(UseArtikulNetworkCommand), 118);
	}
}
